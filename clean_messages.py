...
# Write a csv for all the different users you've had a conversation with
def get_csvs(path_to_messages, path_out):
    contents = codecs.open(path_to_messages, 'r')
    soup = BeautifulSoup(contents.read(), 'lxml')
